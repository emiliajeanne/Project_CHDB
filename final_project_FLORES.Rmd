...
Code for the analysis can be found here: [emiliajeanne](https://github.com/emiliajeanne/Project_CHDB.git)
...
deviance(model_1)
result <- (1 - (pchisq(deviance(model_1), df.residual(model_1)))) # The p-value is very small, indicating evidence of lack of fit.
result
```
